...
class Net(torch.nn.Module):
    ...
    def get_view_for(self,n,masks):
        ...
        if n=='fc1.weight':
            ...
            pre=gc3.data.view(-1,1,1).expand((self.ec3.weight.size(1),
                                              self.smid,
