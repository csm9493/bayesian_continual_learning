...
parser.add_argument('--date', type=str, default='190428', help='date of running experiment')
...
def run(args):
    ...
    if args.ewc:
        train_info['reg_coef'] = args.ewc_lambda
        if args.online:
            method = 'online_ewc'
        else:
            method = 'ewc'
        ...
        method = 'si'
        train_info['reg_coef'] = args.si_c
    else:
        method = 'unrecognized'
    train_info['alg'] = method
    train_info['trial'] = args.seed
    train_info['date'] = args.date
    train_info['units'] = args.fc_units
    ...
    train_cl(
        ...
        eval_cbs_exemplars=eval_cbs_exemplars, use_exemplars=args.use_exemplars, add_exemplars=args.add_exemplars, train_info=train_info
    )
